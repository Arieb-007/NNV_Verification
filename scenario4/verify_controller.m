...
Controller1 = FFNNS(Layers); % feedforward neural network controller
Controller2 = FFNNS(Layers);
...
Plant1 = NonLinearODE(6, 1, @car_dynamics1, reachStep, controlPeriod, output_mat);
Plant2 = NonLinearODE(6, 1, @car_dynamics2, reachStep, controlPeriod, output_mat);

feedbackMap = [0]; % feedback map, y[k] 

ncs1 = NNCS(Controller1, Plant1, feedbackMap); % the neural network control system
ncs2 = NNCS(Controller2, Plant2, feedbackMap);
